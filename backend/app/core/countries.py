...
COUNTRIES: tuple[Country, ...] = (
    ...
    Country("SD", "苏丹", REGION_AFRICA, False, True),
    Country("ML", "马里", REGION_AFRICA, False, True),
    Country("NE", "尼日尔", REGION_AFRICA, False, True),
    Country("TD", "乍得", REGION_AFRICA, False, True),
    Country("BF", "布基纳法索", REGION_AFRICA, False, True),
    Country("GN", "几内亚", REGION_AFRICA, False, True),
    Country("BJ", "贝宁", REGION_AFRICA, False, True),
    Country("TG", "多哥", REGION_AFRICA, False, True),
    Country("SL", "塞拉利昂", REGION_AFRICA, False, True),
    Country("LR", "利比里亚", REGION_AFRICA, False, True),
    Country("MR", "毛里塔尼亚", REGION_AFRICA, False, True),
    Country("ER", "厄立特里亚", REGION_AFRICA, False, True),
    Country("DJ", "吉布提", REGION_AFRICA, False, True),
    Country("SO", "索马里", REGION_AFRICA, False, True),
    Country("SS", "南苏丹", REGION_AFRICA, False, True),
    Country("CF", "中非共和国", REGION_AFRICA, False, True),
    Country("CG", "刚果(布)", REGION_AFRICA, False, True),
    Country("GQ", "赤道几内亚", REGION_AFRICA, False, True),
    Country("ST", "圣多美和普林西比", REGION_AFRICA, False, True),
    Country("KM", "科摩罗", REGION_AFRICA, False, True),
    Country("MU", "毛里求斯", REGION_AFRICA, False, True),
    Country("SC", "塞舌尔", REGION_AFRICA, False, True),
    Country("MG", "马达加斯加", REGION_AFRICA, False, True),
    Country("MW", "马拉维", REGION_AFRICA, False, True),
    Country("LS", "莱索托", REGION_AFRICA, False, True),
    Country("SZ", "斯威士兰", REGION_AFRICA, False, True),
    Country("NA", "纳米比亚", REGION_AFRICA, False, True),
    Country("CV", "佛得角", REGION_AFRICA, False, True),
    Country("GW", "几内亚比绍", REGION_AFRICA, False, True),
    Country("GM", "冈比亚", REGION_AFRICA, False, True),
    # ---- 拉美扩充 ----
    Country("GT", "危地马拉", REGION_LATAM, False, True),
    Country("HN", "洪都拉斯", REGION_LATAM, False, True),
    Country("SV", "萨尔瓦多", REGION_LATAM, False, True),
    Country("NI", "尼加拉瓜", REGION_LATAM, False, True),
    Country("CR", "哥斯达黎加", REGION_LATAM, False, True),
    Country("PA", "巴拿马", REGION_LATAM, False, True),
    Country("JM", "牙买加", REGION_LATAM, False, True),
    Country("TT", "特立尼达和多巴哥", REGION_LATAM, False, True),
    Country("HT", "海地", REGION_LATAM, False, True),
    Country("BS", "巴哈马", REGION_LATAM, False, True),
    Country("GY", "圭亚那", REGION_LATAM, False, True),
    Country("SR", "苏里南", REGION_LATAM, False, True),
    # ---- 欧洲扩充 ----
    Country("LU", "卢森堡", REGION_EUROPE, False, False),
    Country("IS", "冰岛", REGION_EUROPE, False, False),
    Country("EE", "爱沙尼亚", REGION_EUROPE, False, False),
    Country("LV", "拉脱维亚", REGION_EUROPE, False, False),
    Country("LT", "立陶宛", REGION_EUROPE, False, False),
    Country("SI", "斯洛文尼亚", REGION_EUROPE, False, False),
    Country("HR", "克罗地亚", REGION_EUROPE, False, False),
    Country("RS", "塞尔维亚", REGION_EUROPE, False, True),
    Country("BA", "波黑", REGION_EUROPE, False, True),
    Country("MK", "北马其顿", REGION_EUROPE, False, True),
    Country("AL", "阿尔巴尼亚", REGION_EUROPE, False, True),
    Country("ME", "黑山", REGION_EUROPE, False, True),
    Country("MD", "摩尔多瓦", REGION_EUROPE, False, True),
    Country("MT", "马耳他", REGION_EUROPE, False, False),
    Country("CY", "塞浦路斯", REGION_EUROPE, False, False),
    # ---- 大洋洲扩充 ----
    Country("PG", "巴布亚新几内亚", REGION_OCEANIA, False, True),
    Country("WS", "萨摩亚", REGION_OCEANIA, False, True),
    Country("TO", "汤加", REGION_OCEANIA, False, True),
    Country("VU", "瓦努阿图", REGION_OCEANIA, False, True),
    Country("SB", "所罗门群岛", REGION_OCEANIA, False, True),
    # ---- 南亚扩充 ----
    Country("MV", "马尔代夫", REGION_SOUTH_ASIA, False, True),
    Country("BT", "不丹", REGION_SOUTH_ASIA, False, True),
)
