...
CODE_PASSWORD_CHANGE_REQUIRED = 2005  # 强制改密（初始密码未修改，业务接口拒绝）
...
CODE_SETUP_COMPLETED = 4005      # 安装向导已完成，写端点关闭
CODE_LICENSE_EXPIRED = 4006      # 许可已到期，业务写接口只读
...
_HTTP_BY_CODE = {
    ...
    CODE_PASSWORD_CHANGE_REQUIRED: 403,
    CODE_NOT_FOUND: 404,
    CODE_CONFLICT: 409,
    CODE_STATE_INVALID: 422,
    CODE_QUOTA_EXCEEDED: 422,
    CODE_DATA_INSUFFICIENT: 422,
    CODE_SETUP_COMPLETED: 409,
    CODE_LICENSE_EXPIRED: 403,
